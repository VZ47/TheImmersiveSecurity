...
Get access to intruders data. First option button "Emulate screen in hidden mode", Second option button "System dumb download in 13g.hidden mode"
Upload a file to intruders computer. Button "Upload file to intruder"
Enable.13g.powersupply.mode.computer.run.in.case.shutdown. Also, prevent.reboot, prevent.complete.shutdown. Button 'Control the intruders device in case the computer runs loud and we want to keep access to device'
...
Auto.Push.Update with 0ns protocol from source SOCKS5://github.com/VZ47/TheImmersiveSecurity/blob/9107b56f6e70bc62e7d53bbf949bb7844435d887/TheImmersiveAntivirus.java
